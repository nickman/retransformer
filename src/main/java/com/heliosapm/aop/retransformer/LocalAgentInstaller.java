 ...
 * <p><code>com.heliosapm.aop.retransformer.LocalAgentInstaller</code></p>
 */
public class LocalAgentInstaller  {
	...
	/** The acquired instrumentation instance */
	protected static volatile Instrumentation instrumentation = null;
	...
	public synchronized static Instrumentation getInstrumentation() {
		try {
			...
			throw new RuntimeException("Failed to get Instrumentation", ex);
		}
	}
	 ...
	 * @throws AttachNotSupportedException 
	 */
	public synchronized static Instrumentation getInstrumentation(long timeout) throws AttachNotSupportedException, IOException {		
		if(instrumentation!=null) return instrumentation;
		try {
			instrumentation = (Instrumentation)ManagementFactory.getPlatformMBeanServer().getAttribute(AgentInstrumentation.AGENT_INSTR_ON, "Instrumentation");
